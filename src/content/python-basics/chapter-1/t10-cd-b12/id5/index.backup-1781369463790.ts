  ...
  testCases: [
    {
      ...
      expected: "slx ozk girms gszg efr",
      description: "Test case 1",
      sceneText: "Level 1",
    },
    {
      input: "Hoc python rat la kho luon do ",
      expected: "Slx kbgslm izg oz psl oflm wl",
      description: "Test case 2",
      sceneText: "Level 2",
    },
    {
      input: "Truong THPT AAA",
      expected: "Giflmt GSKG ZZZ",
      description: "Test case 3",
      sceneText: "Level 3",
    },
    {
      input: "Phai lam sao de hoc gioi tin hoc ?",
      expected: "Kszr ozn hzl wv slx trlr grm slx ?",
      description: "Test case 4",
      sceneText: "Level 4",
    },
    {
      input: "Toi rat thich lap trinh bang python. I love python......",
      expected: "Glr izg gsrxs ozk girms yzmt kbgslm. R olev kbgslm......",
      description: "Test case 5",
      sceneText: "Level 5",
    },
    {
      input: "Bien so xe 29A - 123.45",
      expected: "Yrvm hl cv 29Z - 123.45",
